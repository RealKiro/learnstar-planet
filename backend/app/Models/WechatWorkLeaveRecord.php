...
class WechatWorkLeaveRecord extends Model
{
    ...
    public static function findForStudentOnDate(int $studentId, string $date): ?self
    {
        return static::where('student_id', $studentId)->where('approve_status', 'approved')->whereDate('leave_start_date', '<=', $date)->whereDate('leave_end_date', '>=', $date)->latest('approved_at')->first();
    }

    /** @return \Illuminate\Database\Eloquent\Collection<int, static> */
    public static function getUnsyncedForDate(string $date)
    {

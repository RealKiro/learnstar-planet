 ...
 */
const SVG_MANIFEST: string[] = ['zhulong', 'charmander', 'sun_wukong', 'nezha', 'zhong_kui', 'jiang_ziya', 'yang_jian', 'lei_zhenzi', 'huang_tianhua', 'tu_xingsun', 'yang_ren', 'wei_hu', 'daji', 'shen_gongbao', 'lv_dongbin', 'he_xiangu', 'zhang_guolao', 'tie_guaili', 'han_zhongli', 'lan_caihe', 'cao_guojiu', 'taishang_laojun', 'aries', 'taurus', 'gemini', 'cancer']

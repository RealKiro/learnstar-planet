    ...
    species: [
      {
        ...
        levels: [
          ...
          { level: 7, name: '水晶墙', description: '一面晶莹的水晶之墙在身前展开，坚不可摧', stage: 'growing', requiredScore: 165 },
          { level: 8, name: '星屑旋转功', description: '双手舞动，召唤旋转的星屑如银河倾泻', stage: 'mature', requiredScore: 210 },
          { level: 9, name: '白羊宫主', description: '身着白羊黄金圣衣，端坐白羊宫守护圣域之门', stage: 'mature', requiredScore: 260 },
          { level: 10, name: '圣衣修复师', description: '指尖微光流转，将碎裂的圣衣缓缓修复如新', stage: 'mature', requiredScore: 315 },
          { level: 11, name: '星光灭绝', description: '星光化作漫天洪流吞没敌影，却仍带着慈悲', stage: 'legendary', requiredScore: 375 },
          { level: 12, name: '圣域智者', description: '看透轮回与宿命，以睿智与温柔守护信念', stage: 'legendary', requiredScore: 450 },
        ],
      },
      {
        ...
        levels: [
          ...
          { level: 7, name: '巨型号角', description: '猛然抬头，金色冲击波将敌手掀飞千丈', stage: 'growing', requiredScore: 165 },
          { level: 8, name: '勇猛无畏', description: '大步流星冲入敌阵，力量与热血并进', stage: 'mature', requiredScore: 210 },
          { level: 9, name: '金牛宫主', description: '身披金牛黄金圣衣守护金牛宫，憨厚可靠', stage: 'mature', requiredScore: 260 },
          { level: 10, name: '圣域之盾', description: '以魁梧身躯挡在同伴之前，是最可靠的战友', stage: 'mature', requiredScore: 315 },
          { level: 11, name: '黄金之角', description: '双角化作惊天巨号，一声怒吼震裂天地', stage: 'legendary', requiredScore: 375 },
          { level: 12, name: '赤诚勇士', description: '豪爽忠勇，为守护同伴倾尽全力，令人敬服', stage: 'legendary', requiredScore: 450 },
        ],
      },
      {
        ...
        levels: [
          ...
          { level: 7, name: '异次元空间', description: '双手一合，将敌手卷入无尽的异次元', stage: 'growing', requiredScore: 165 },
          { level: 8, name: '堕落之影', description: '善念沉眠，邪恶化身成为伪教皇君临圣域', stage: 'mature', requiredScore: 210 },
          { level: 9, name: '双子宫主', description: '身披双子黄金圣衣，善恶两魂在衣上对峙', stage: 'mature', requiredScore: 260 },
          { level: 10, name: '银河星爆雏形', description: '双手凝聚星云之力，银河在掌中缓缓盘旋', stage: 'mature', requiredScore: 315 },
          { level: 11, name: '银河星爆', description: '星云爆发，银河粉碎，光芒吞没一切', stage: 'legendary', requiredScore: 375 },
          { level: 12, name: '善之回归', description: '战胜内心黑暗，以神之化身守护雅典娜', stage: 'legendary', requiredScore: 450 },
        ],
      },
      {
        ...
        levels: [
          ...
          { level: 7, name: '积尸气冥界波', description: '冥界波横扫，将敌人的灵魂拖向冥界深渊', stage: 'growing', requiredScore: 165 },
          { level: 8, name: '邪气凛然', description: '狂妄大笑，积尸气缠身如冥界君主', stage: 'mature', requiredScore: 210 },
          { level: 9, name: '巨蟹宫主', description: '身披巨蟹黄金圣衣，镇守通往冥界的门', stage: 'mature', requiredScore: 260 },
          { level: 10, name: '冥界通道', description: '双手一划，开启通往冥界的通道，亡魂低语', stage: 'mature', requiredScore: 315 },
          { level: 11, name: '冥界之王', description: '与冥界之力共鸣，积尸气如海啸吞没一切', stage: 'legendary', requiredScore: 375 },
          { level: 12, name: '因果报应', description: '终悟善恶有报，以冥界之力惩罚真正的邪恶', stage: 'legendary', requiredScore: 450 },
        ],
      },
      {
        ...
        levels: [
          ...
          { level: 7, name: '闪电光速拳', description: '光速之拳如雷暴倾泻，撕裂空气', stage: 'growing', requiredScore: 165 },
          { level: 8, name: '光明磊落', description: '光明正大对敌，气势如虹令宵小胆寒', stage: 'mature', requiredScore: 210 },
          { level: 9, name: '狮子宫主', description: '身披狮子黄金圣衣守护狮子宫，意气风发', stage: 'mature', requiredScore: 260 },
          { level: 10, name: '雷光之鬃', description: '鬃毛化作金色雷光，拳风撕天裂地', stage: 'mature', requiredScore: 315 },
          { level: 11, name: '等离子光速拳', description: '光速拳化作等离子风暴，灼烧一切黑暗', stage: 'legendary', requiredScore: 375 },
          { level: 12, name: '正义雷光', description: '以热血与正义化为雷霆，荡尽世间邪恶', stage: 'legendary', requiredScore: 450 },
        ],
      },
      {
        ...
        levels: [
          ...
          { level: 7, name: '天魔降伏', description: '佛光绽放，一掌降伏天魔，梵音缭绕', stage: 'growing', requiredScore: 165 },
          { level: 8, name: '曼陀罗光', description: '周身曼陀罗光华流转，神圣不可侵', stage: 'mature', requiredScore: 210 },
          { level: 9, name: '处女宫主', description: '身披处女黄金圣衣，端坐处女宫悟道修行', stage: 'mature', requiredScore: 260 },
          { level: 10, name: '天舞宝轮', description: '化出攻防一体的宝轮，剥夺敌人的六感', stage: 'mature', requiredScore: 315 },
          { level: 11, name: '第八感觉醒', description: '于沙罗双树下领悟第八感，超脱生死轮回', stage: 'legendary', requiredScore: 375 },
          { level: 12, name: '佛陀化身', description: '慧眼洞彻宇宙真相，以身护道，慈悲无量', stage: 'legendary', requiredScore: 450 },
        ],
      },
      {
        ...
        levels: [
          ...
          { level: 7, name: '庐山升龙霸', description: '升龙拳出，青龙盘柱而上，惊天动地', stage: 'growing', requiredScore: 165 },
          { level: 8, name: '天秤武库', description: '手抚天秤黄金武器，可拆解出十二件神兵', stage: 'mature', requiredScore: 210 },
          { level: 9, name: '老师坐镇', description: '以假死之术镇守五老峰，被世人尊称"老师"', stage: 'mature', requiredScore: 260 },
          { level: 10, name: '天秤宫主', description: '身披天秤黄金圣衣，十八般武器任取', stage: 'mature', requiredScore: 315 },
          { level: 11, name: '返老还童', description: '小宇宙苏醒恢复青春之躯，重现战神威仪', stage: 'legendary', requiredScore: 375 },
          { level: 12, name: '庐山龙神', description: '升龙霸威震八荒，守护大地两百年不灭', stage: 'legendary', requiredScore: 450 },
        ],
      },
      {
        ...
        levels: [
          ...
          { level: 7, name: '深红毒针', description: '十五针连发如天蝎甩尾，针针致命', stage: 'growing', requiredScore: 165 },
          { level: 8, name: '忠肝义胆', description: '为挚友甘愿流血，为正义绝不动摇', stage: 'mature', requiredScore: 210 },
          { level: 9, name: '天蝎宫主', description: '身披天蝎黄金圣衣守护天蝎宫，耿直豪迈', stage: 'mature', requiredScore: 260 },
          { level: 10, name: '针之神技', description: '毒针可留人活口亦可瞬间夺命，收发由心', stage: 'mature', requiredScore: 315 },
          { level: 11, name: '天蝎之怒', description: '深红毒针如暴雨倾泻，刺破一切罪恶', stage: 'legendary', requiredScore: 375 },
          { level: 12, name: '赤诚星辰', description: '忠义长存，深红针芒化作守护同伴的星光', stage: 'legendary', requiredScore: 450 },
        ],
      },
      {
        ...
        levels: [
          ...
          { level: 7, name: '黄金之箭', description: '弯弓搭箭，箭尖汇聚出黄金光芒', stage: 'growing', requiredScore: 165 },
          { level: 8, name: '守护雅典娜', description: '为救雅典娜拼死突围，将婴儿托付他人', stage: 'mature', requiredScore: 210 },
          { level: 9, name: '英魂长存', description: '英魂寄于射手圣衣，指引少年们前行', stage: 'mature', requiredScore: 260 },
          { level: 10, name: '射手宫主', description: '身披射手黄金圣衣，箭意穿过十二宫', stage: 'mature', requiredScore: 315 },
          { level: 11, name: '黄金之箭·觉醒', description: '英魂苏醒，射出贯穿一切黑暗的黄金之箭', stage: 'legendary', requiredScore: 375 },
          { level: 12, name: '守护之魂', description: '牺牲精神化作永恒星光，守护雅典娜直至永远', stage: 'legendary', requiredScore: 450 },
        ],
      },
      {
        ...
        levels: [
          ...
          { level: 7, name: '剑影纵横', description: '圣剑连斩，剑气纵横交错成网', stage: 'growing', requiredScore: 165 },
          { level: 8, name: '摩羯之斩', description: '为忠诚而挥剑，不辨善恶只守信义', stage: 'mature', requiredScore: 210 },
          { level: 9, name: '摩羯宫主', description: '身披摩羯黄金圣衣，镇守摩羯宫剑指来敌', stage: 'mature', requiredScore: 260 },
          { level: 10, name: '圣剑加身', description: '全身化作无数圣剑，攻势如万剑齐发', stage: 'mature', requiredScore: 315 },
          { level: 11, name: '觉醒之剑', description: '在舍身中顿悟，圣剑化为守护之刃', stage: 'legendary', requiredScore: 375 },
          { level: 12, name: '忠诚之剑', description: '以忠诚为魂，圣剑斩恶护善，至死不渝', stage: 'legendary', requiredScore: 450 },
        ],
      },
      {
        ...
        levels: [
          ...
          { level: 7, name: '绝对零度之道', description: '追求绝对零度，冰拳所过万物冻结', stage: 'growing', requiredScore: 165 },
          { level: 8, name: '曙光微光', description: '拳中孕育曙光女神般的金色光芒', stage: 'mature', requiredScore: 210 },
          { level: 9, name: '水瓶宫主', description: '身披水瓶黄金圣衣，端坐水瓶宫冷峻如霜', stage: 'mature', requiredScore: 260 },
          { level: 10, name: '曙光女神之宽恕', description: '曙光初现，冰封一切却又留下一线生机', stage: 'mature', requiredScore: 315 },
          { level: 11, name: '冰河之师', description: '师徒对决中舍命成全，将绝对零度传于弟子', stage: 'legendary', requiredScore: 375 },
          { level: 12, name: '永恒之冰', description: '严寒之下是炽热的师者之心，冰封中透着慈爱', stage: 'legendary', requiredScore: 450 },
        ],
      },
      {
        ...
        levels: [
          ...
          { level: 7, name: '食人鱼玫瑰', description: '玫瑰化作食人鱼群，撕咬吞噬', stage: 'growing', requiredScore: 165 },
          { level: 8, name: '玫瑰花园', description: '遍地玫瑰怒放，美丽而杀机四伏', stage: 'mature', requiredScore: 210 },
          { level: 9, name: '双鱼宫主', description: '身披双鱼黄金圣衣，镇守双鱼宫，花海漫漫', stage: 'mature', requiredScore: 260 },
          { level: 10, name: '血腥玫瑰', description: '玫瑰刺入心口，以最凄美之姿赐死', stage: 'mature', requiredScore: 315 },
          { level: 11, name: '凄美绽放', description: '为守护绽放最后一朵玫瑰，美丽与牺牲同在', stage: 'legendary', requiredScore: 375 },
          { level: 12, name: '永恒之花', description: '玫瑰盛开之处，美丽、忠诚与希望永不凋零', stage: 'legendary', requiredScore: 450 },
        ],
      },
    ],
  },

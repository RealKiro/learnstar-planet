...
export const PET_ART: Record<string, PetArtConfig> = {
  ...
  sabertooth:    { body: 'quadruped', main: '#92400E', parts: { horns: 4, tail: 3, crown: 9 } },
  ...
  // ===== 民间传说 =====
  nian:          { body: 'quadruped', main: '#EF4444', parts: { horns: 4, tail: 3, crown: 8 } },
  ...
  // ===== 扩充：元素 =====
  ice_fox: { body: 'quadruped', main: '#38BDF8', parts: { tail: 3, horns: 9 } },
  rock_rhino: { body: 'quadruped', main: '#B45309', parts: { horns: 5, tail: 4, crown: 9 } },
  wind_falcon: { body: 'bird', main: '#22C55E', parts: { wings: 5, tail: 5, crown: 9 } },
  light_deer: { body: 'quadruped', main: '#FDE047', parts: { horns: 5, tail: 4, halo: 8 } },
  dark_panther: { body: 'quadruped', main: '#64748B', parts: { tail: 3, horns: 8, crown: 9 } },
  steel_armadillo: { body: 'quadruped', main: '#94A3B8', parts: { tail: 3, horns: 8, crown: 9 } },
  // ===== 扩充：国宝 =====
  tibetan_antelope: { body: 'quadruped', main: '#F1F5F9', parts: { horns: 5, tail: 4, crown: 9 } },
  snow_leopard: { body: 'quadruped', main: '#CBD5E1', parts: { tail: 3, horns: 8, wings: 11 } },
  milu_deer: { body: 'quadruped', main: '#A16207', parts: { horns: 5, tail: 4, crown: 9 } },
  siberian_tiger: { body: 'quadruped', main: '#F97316', parts: { tail: 3, horns: 8, wings: 11 } },
  red_panda: { body: 'quadruped', main: '#F97316', parts: { tail: 3, crown: 8 } },
  ...
  wand_cat: { body: 'quadruped', main: '#8B5CF6', parts: { tail: 3, horns: 8, crown: 9 } },
  ...
  // ===== 扩充：民间 =====
  lion_dance: { body: 'quadruped', main: '#EF4444', parts: { horns: 5, tail: 3, crown: 8 } },

...
<template>
  <div style="min-height:100vh;display:flex;justify-content:center;background:#0F172A;">
    <!-- 左侧：项目介绍轮播 -->
    <div class="intro-panel" style="flex:1;max-width:680px;position:relative;overflow:hidden;display:flex;align-items:center;justify-content:center;padding:48px 64px;">
      <!-- 背景光效 -->

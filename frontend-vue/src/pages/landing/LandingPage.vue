  ...
  <div class="home">
    ...
    <header class="topbar">
      ...
      <div class="topbar-links">
        <button class="topbar-btn topbar-btn--dim" @click="goLogin">教师登录</button>
        <button class="topbar-btn topbar-btn--dim" @click="goLogin">管理员</button>
        <button class="topbar-btn topbar-btn--dim" @click="goLogin">家长</button>
    ...
    <main class="main">
      ...
      <section class="right">
        <div class="panel">
          ...
          <div class="panel-alt">
            <button class="panel-alt-btn" @click="goLogin">👨‍🏫 教师</button>
            <button class="panel-alt-btn" @click="goLogin">👨‍👩‍👧‍👦 家长</button>
            <button class="panel-alt-btn" @click="goLogin">⚙️ 管理</button>
          </div>
        </div>
      </section>
    </main>

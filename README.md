...
| **数据报表** | 分年级/分班级统计 |
| **第三方登录配置** | 后端微信/QQ/企业微信/人人接口已实现，前端已实现 OAuth 跳转和回调页面 |
...
| **Excel 导出** ✅ | 支持导出积分报表、宠物报表、考勤报表（.xlsx 格式） |
| **AI 助教** ⚠️ | 已对接 DeepSeek / OpenAI / 通义千问 / Moonshot，需在 .env 中配置 AI_PROVIDER 和 AI_API_KEY 后方可实际使用 |

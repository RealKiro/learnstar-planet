...
exports.PET_SERIES = exports.SPECIES_EMOJI = exports.SERIES_SCENES = void 0;
exports.getLevelRequiredScore = getLevelRequiredScore;
exports.getLevelStage = getLevelStage;
exports.getLevelTitle = getLevelTitle;
exports.getSpeciesEmoji = getSpeciesEmoji;
exports.getSeriesEmoji = getSeriesEmoji;
exports.getSeriesName = getSeriesName;
exports.getSpeciesById = getSpeciesById;
exports.getSeriesBySpeciesId = getSeriesBySpeciesId;
exports.getLevelData = getLevelData;
exports.getPetLevelName = getPetLevelName;
exports.getPetLevelDescription = getPetLevelDescription;
exports.getAllSeries = getAllSeries;
exports.getSpeciesBySeries = getSpeciesBySeries;
const petDataExtended_1 = require("./petDataExtended");
/** 获取等级所需累计积分(与各物种 requiredScore 一致的统一阈值表 Lv.0~12) */
function getLevelRequiredScore(level) {
...
function getSpeciesEmoji(speciesId) {
    return exports.SPECIES_EMOJI[speciesId] || '🌟';
}
/** 获取系列Emoji */
function getSeriesEmoji(seriesId) {
    const map = {
        myth: '🏔️',
        pokemon: '⚡',
        national: '🐼',
        ...
        species: [
            ...
            },
            {
                ...
                levels: [
                    ...
                    { level: 6, name: '四尾', description: '四尾初成，尾尖泛起月白银光，狐火隐现', stage: 'growing', requiredScore: 125 },
            ...
            },
            {
                ...
                levels: [
                    ...
                    { level: 2, name: '幼鲲', description: '幼鲲渐长，背鳍如帆初展，深海中悄然蓄力', stage: 'egg', requiredScore: 15 },
        ...
        species: [
            {
                ...
                levels: [
                    ...
                    { level: 6, name: '火恐龙', description: '鳞甲渐亮，头顶角芽初生，尾火愈发炽烈', stage: 'growing', requiredScore: 125 },
            ...
            },
            {
                ...
                levels: [
                    ...
                    { level: 5, name: '水枪龟', description: '水枪初成，尾鳍舒展，蓄水之势渐显', stage: 'growing', requiredScore: 90 },
                    { level: 6, name: '卡咪龟', description: '甲壳渐隆，壳缘浮现圆润突起，蓄力欲发', stage: 'growing', requiredScore: 125 },
            ...
            },
            {
                ...
                levels: [
                    ...
                    { level: 7, name: '元素显现', description: '身周元素光流转，毛色随性向微微泛光', stage: 'mature', requiredScore: 165 },
            ...
            },
            {
                ...
                levels: [
                    ...
                    { level: 6, name: '雷丘雏形', description: '双颊电囊鼓胀，闪电尾渐粗，电光周身流转', stage: 'growing', requiredScore: 125 },
        ...
        species: [
            ...
            },
            {
                ...
                levels: [
                    ...
                    { level: 4, name: '少年虎', description: '少年虎初立领地，王字渐显，目光初锐', stage: 'baby', requiredScore: 60 },
            ...
            },
            {
                ...
                levels: [
                    ...
                    { level: 4, name: '少年鳄', description: '幼鳄初长，尾蓄雷霆，硬鳞渐显威仪', stage: 'baby', requiredScore: 60 },
...
// ============================================================
for (const series of exports.PET_SERIES) {
    const extra = petDataExtended_1.EXTRA_SPECIES[series.id];
    if (extra?.length) {
        series.species.push(...extra);
    }
}
exports.PET_SERIES.push(...petDataExtended_1.EXTRA_SERIES);
...
/** 根据物种ID获取系列 */
function getSeriesBySpeciesId(speciesId) {
    for (const series of exports.PET_SERIES) {
        if (series.species.some(s => s.id === speciesId))
            return series;
    }
    return undefined;
}
/** 获取指定等级的数据 */
function getLevelData(speciesId, level) {
...
/** 获取宠物当前等级名称 */
function getPetLevelName(speciesId, level) {
    const data = getLevelData(speciesId, level);
    return data?.name || `Lv.${level}`;
}
/** 获取宠物当前等级描述 */
function getPetLevelDescription(speciesId, level) {
    const data = getLevelData(speciesId, level);
    return data?.description || '';
}
/** 获取全部系列（用于选择面板） */
function getAllSeries() {
    return exports.PET_SERIES;
}
/** 获取系列中的物种 */
function getSpeciesBySeries(seriesId) {
    const series = exports.PET_SERIES.find(s => s.id === seriesId);
